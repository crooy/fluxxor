...
var _lodash11 = __webpack_require__(18);
...
var _lodash15 = __webpack_require__(19);
...
var Dispatcher = function () {
  ...
  _createClass(Dispatcher, [{
    ...
    value: function doDispatchLoop(action) {
      ...
      if ((0, _lodash12.default)(this.waitingToDispatch)) {
        this.doDispatchLoop(action);
      }
    ...
    value: function waitForStores(store, stores, fn) {
      ...
      var waitingStoreName = (0, _lodash14.default)(this.stores, function (val) {
        return val === store;
      });
      ...
      dispatch.waitingOn = (0, _lodash16.default)(dispatch.waitingOn.concat(stores));
...
var _objectPath = __webpack_require__(20);
...
var Flux = function (_EventEmitter) {
  ...
  _createClass(Flux, [{
    ...
    value: function addAction() {
      ...
      var leadingPaths = (0, _lodash2.default)(args, function (acc, next) {
        if (acc) {
      ...
      leadingPaths.forEach(function (path) {
        if (typeof _objectPath2.default.get(_this2.actions, path) === 'function') {
